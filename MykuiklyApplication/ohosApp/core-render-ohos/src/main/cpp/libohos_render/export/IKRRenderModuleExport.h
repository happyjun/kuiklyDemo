 ...
 public:
    ...
    KRAnyValue ToCallArkTSMethod(bool isSync, const std::string &module_name, const std::string &method,
        ...
        auto result = new KRResult();
         KR_LOG_INFO << "schedule ToCallArkTSMethod isSync=" << isSync  << "module_name= "+module_name + "方法="+method ;
        KRContextScheduler::ScheduleTaskOnMainThread(
            isSync, [isSync, result, module_name, method, instnce_id, params, callback, callback_keep_alive] {
               ...
               KR_LOG_INFO << "开始执行 ToCallArkTSMethod isSync=" << isSync  << "module_name= "+module_name + "方法="+method ;
            ...
            KR_LOG_INFO << "结束执行 ToCallArkTSMethod isSync=" << isSync  << "module_name= "+module_name + "方法="+method ;
                if (isSync) {
